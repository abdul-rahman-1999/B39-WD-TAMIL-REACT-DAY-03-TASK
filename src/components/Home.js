...
function Home() {
    ...
    let ratingChanged1 = (rating) => {
        setRating2(rating)
      }
      let ratingChanged2 = (rating) => {
        setRating3(rating)
      }
                            ...
                            <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                {
                                    toggle1?<div className="text-center"><button className="btn btn-outline-dark mt-auto" onClick={()=>{
                                        ...
                                        setToggle1(!toggle1)
                                    }} href="javascript(void)">Add to cart</button></div>
                                    :
                                    <div className="text-center"><button className="btn btn-outline-dark mt-auto" onClick={()=>{
                                        setcartValue(cartValue-1)
                                        setToggle1(!toggle1)
                                    }} href="javascript(void)">Remove cart</button></div>
                                }
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card h-100">
                            ...
                            <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            {
                                    ...
                                    <div className="text-center"><button className="btn btn-outline-dark mt-auto" onClick={()=>{
                                        setcartValue(cartValue-1)
                                        setToggle2(!toggle2)
                                    }} href="javascript(void)">Remove From cart</button></div>
                                }
                            </div>
                        </div>
                    </div>
